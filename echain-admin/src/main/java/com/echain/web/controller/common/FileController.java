...
public class FileController extends AbsSupperController {
	...
	private JsonResult multipartFile2DB(MultipartFile file,String name) {
		...
		dbFile.setName(name);
		dbFile.setCreatePin(user.getNo());
		try {
	 ...
	 * 图片后缀
	 */
	protected static final Map<String, String> imgMediaType = ImmutableMap.of(
			"jpg","image/jpeg",
			"jpeg","image/jpeg",
			"gif","image/gif",
			"png","image/png",
