...
//		filterChainDefinitionMap.put("/webjars/**", "anon");
		...
		filterChainDefinitionMap.put("/api/forgetPwd*", "anon");
		filterChainDefinitionMap.put("/api/question/select*", "anon");
		filterChainDefinitionMap.put("/api/question/add*", "anon");
		filterChainDefinitionMap.put("/api/changeType/select*", "anon");
		filterChainDefinitionMap.put("/api/machine/query*", "anon");
		filterChainDefinitionMap.put("/api/file/**", "anon");
		filterChainDefinitionMap.put("/api/card/save*", "anon");
		filterChainDefinitionMap.put("/api/exchangeRate/get*", "anon");
		filterChainDefinitionMap.put("/api/transferFee/get*", "anon");
		filterChainDefinitionMap.put("/api/cashOutFee/get*", "anon");
		filterChainDefinitionMap.put("/api/newsInfo/**", "anon");
		filterChainDefinitionMap.put("/api/getCiphertext*", "anon");
		filterChainDefinitionMap.put("/api/getPlaintext*", "anon");
		filterChainDefinitionMap.put("/api/_debug/**", "anon");
